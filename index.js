...
var db = level('yunmai_weights.db', {valueEncoding : 'json'});
  ...
  request(options)
    .then(function (response) {
     ...
     // Set Column Headers
      requests.push({
        updateCells: {
          start: {sheetId: gSheetsTabId, rowIndex: row, columnIndex: column},
          rows: [{
            values: [{
              ...
              userEnteredValue: {stringValue: "BMI"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "BMR"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Bone"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Body Fat"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Muscle"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Protein"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Resistance"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Body Age"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Visceral Fat"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }, {
              userEnteredValue: {stringValue: "Water"},
              userEnteredFormat: {textFormat: {"bold": true}}
            }]
          }],
  ...
  // read the whole LevelDB store as a stream and generate CSV and update GSheets
    db.createReadStream()
      .on('data', function (data) { 
        ...
        wstream.write(data.value.createTime + ', ' + data.value.weight + ', ' + data.value.bmi + ', ' + data.value.bmr + ', ' + data.value.bone + ', ' + data.value.fat + ', ' + data.value.muscle + ', ' + data.value.protein + ', ' + data.value.resistance + ', ' + data.value.somaAge + ', ' + data.value.visFat + ', ' + data.value.water + '\n');
        ...
        requests.push({
          updateCells: {
            ...
            rows: [{
              values: [{
                userEnteredValue: {stringValue: data.value.createTime},
                userEnteredFormat: {
                numberFormat: {
                  type: "DATE",
                ...
                userEnteredValue: {numberValue: data.value.weight}
              }, {
                userEnteredValue: {numberValue: data.value.bmi}
              }, {
                userEnteredValue: {numberValue: data.value.bmr}
              }, {
                userEnteredValue: {numberValue: data.value.bone}
              }, {
                userEnteredValue: {numberValue: data.value.fat}
              }, {
                userEnteredValue: {numberValue: data.value.muscle}
              }, {
                userEnteredValue: {numberValue: data.value.protein}
              }, {
                userEnteredValue: {numberValue: data.value.resistance}
              }, {
                userEnteredValue: {numberValue: data.value.somaAge}
              }, {
                userEnteredValue: {numberValue: data.value.visFat}
              }, {
                userEnteredValue: {numberValue: data.value.water},
              }]
            }],
